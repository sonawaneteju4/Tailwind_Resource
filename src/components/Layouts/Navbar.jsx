...
const Navbar = () => {
  ...
  const NavItems = [
    ...
    { navItem: "Pricing", path: "pricing", icons: <TbCloudDollar /> },
    { navItem: "Contact Us", path: "contactus", icons: <CiPhone /> },
  ];
  return (
    <>
      <div className="w-screen p-2  flex items-center justify-between top-0 sticky backdrop-blur  bg-black/5 z-50">
        ...
        >
          ...
          <span className="border-l-2 pl-3"> Resources</span>
        </div>
        <div className="flex items-center">
          <button className="flex items-center lg:pr-5 pr-0 font-semibold ">
            <div>
              <CiUser></CiUser>
            </div>
            <div
